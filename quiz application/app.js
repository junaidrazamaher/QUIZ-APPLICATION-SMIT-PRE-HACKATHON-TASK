...
function validateAnswer(h) {
    var userAnswer = document.getElementsByClassName('selected')
    if (userAnswer[0].innerHTML == questions[h].answer) {
        marks += 1;
    }
}
